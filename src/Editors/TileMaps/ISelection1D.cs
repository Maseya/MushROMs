...
namespace Maseya.Editors.TileMaps
{
    ...
    /// <summary>
    /// Provides properties and methods for making a selection of data in a
    ...
    public interface ISelection1D : IReadOnlyCollection<int>
    {
        ...
        /// cref="ISelection1D"/>; otherwise <see langword="false"/>.
        /// </returns>
        bool Contains(int index);

        /// <summary>
        /// Creates a new instance of <see cref="ISelection1D"/> that has the
        ...
        /// values from indexes specified by the <see cref=" ISelection1D"/>.
        ...
        /// keys are the integer indexes of the <see cref=" ISelection1D"/> and
        ...
        /// </exception>
        IDictionary<int, T> GetValues<T>(IReadOnlyList<T> collection);
    }
}
