// <copyright file="GfxPixelRenderer.cs" company="Public Domain">
...
namespace Maseya.Snes
{
    ...
    public class GfxPixelRenderer : TileMap1DRenderer
    {
        ...
        public GfxPixelRenderer()
            : base()
        {
        }

        public GfxPixelRenderer(IContainer container)
            : base(container)
        {
        }
